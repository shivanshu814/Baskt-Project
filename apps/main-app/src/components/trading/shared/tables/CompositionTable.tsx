...
import { CompositionTableProps } from '../../../../types/trading/components/tabs';
import {
  calculateAssetTableData,
...
export const CompositionTable: React.FC<CompositionTableProps> = ({ assets }) => {
  const tableData = calculateAssetTableData(assets);
