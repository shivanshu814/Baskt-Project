...
export const VaultInfo = React.memo(({ apy, lastUpdated }: VaultInfoProps) => {
  return (
        ...
        <div className="flex items-center gap-2 text-primary text-xs font-bold mb-1">
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              >
                Annual Percentage Yield is calculated based on vault performance and fees generated.
                <br />
                <br />
                Returns are automatically compounded and distributed to vault participants.
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </div>
