...
const FEATURES = [
  {
    ...
    description:
      'Build your own baskets with multiple assets - minimum 2 assets, no maximum limit. Design portfolios that match your strategy.',
  },
  {
    icon: Brain,
    title: 'AI-Powered Rebalancing',
    description:
      'Automatic rebalancing of assets within baskets using AI to minimize losses and maximize returns for users.',
  },
  {
    icon: Wallet,
    title: 'Trade & Pool Management',
    description:
      'Trade existing baskets or your own creations. Deposit funds, get BLP tokens, and manage your portfolio with ease.',
  },
] as const;
    ...
    <section className="py-16">
      <div className="container mx-auto px-4">
        ...
        <p className="text-muted-foreground text-center mb-12 max-w-2xl mx-auto">
          Everything you need to create, trade, and manage your crypto baskets
        </p>
