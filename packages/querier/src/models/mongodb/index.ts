...
ReferralMetadataSchema.plugin(mongooseLeanGetters, { defaultLeanOptions: { getters: true } });
...
export const WithdrawalRequestModel = mongoose.model(
  'withdrawal_requests',
  WithdrawalRequestSchema,
);
export const RebalanceRequestModel = mongoose.model('rebalance_request', RebalanceRequestSchema);
export const BasktRebalanceHistoryModel = mongoose.model(
  'baskt_rebalance_history',
  BasktRebalanceHistorySchema,
);
...
export const ReferralMetadataModel = mongoose.model('ReferralMetadata', ReferralMetadataSchema);
