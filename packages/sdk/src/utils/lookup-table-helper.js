 ...
 */
export async function createLookupTableInstructions(connection, authority, payer) {
...
export async function extendLookupTable(connection, lookupTableAddress, authority, payer, addresses) {
